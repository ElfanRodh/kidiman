...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Data IKM (Indeks Kepuasan Masyarakat)</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="<?= site_url() ?>">Dashboard</a></div>
        <div class="breadcrumb-item">Data IKM (Indeks Kepuasan Masyarakat)</div>
      </div>
    </div>

    <div class="row align-items-left align-middle p-0 mb-3">
      <div class="col-12 col-md-6">
        <h2 class="section-title">Data IKM (Indeks Kepuasan Masyarakat)</h2>
      </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h4>Data IKM (Indeks Kepuasan Masyarakat)</h4>
            </div>
            <div class="card-body">
              <div class="chart">
                <canvas id="ikmChart" style="height: 300px; width: 100%;"></canvas>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  var tb_data;
  var chartIKM;
  var ikmChartCanvas = $('#ikmChart').get(0).getContext('2d')
  ...
  function createChart(ikm) {
    ...
    chartIKM = new Chart(ikmChartCanvas, {
      type: 'pie',
      data: ikmChartData,
      options: ikmChartOptions
    })
  }
</script>